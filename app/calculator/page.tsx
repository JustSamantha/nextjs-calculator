...
export default function Page() {
  ...
  return (
    <div className="">
      <div className="">
        <Link className="m-auto" href="/">&#60;&#60; Back</Link>
      </div>
      <div className="grid mt-[10px] justify-center items-center w-screen">
        <input className="grid border-1 w-[200px] rounded text-right pr-[5px] pl-[5px] h-[50px]" type="text" value={display} disabled />
        <div className="grid grid-cols-4 grid-rows-5 mt-1">
